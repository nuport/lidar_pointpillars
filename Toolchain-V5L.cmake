...
set(VIBRANTE_PDK "/drive/drive-linux")
#set(VIBRANTE_PDK "/home/nuport/Documents/DRIVEOS/drive-linux")
...
# Set default library search path
set(CMAKE_LIBRARY_PATH ${VIBRANTE_PDK}/lib-target)
...
list(APPEND CMAKE_SYSTEM_INCLUDE_PATH
    "${VIBRANTE_PDK}/filesystem/targetfs/usr/include/${CMAKE_LIBRARY_ARCHITECTURE}"
)
#[[ list(APPEND CMAKE_SYSTEM_INCLUDE_PATH
    "${VIBRANTE_PDK}/filesystem/targetfs/usr/include"
)
list(APPEND CMAKE_SYSTEM_INCLUDE_PATH
    "${VIBRANTE_PDK}/filesystem/targetfs/usr/lib"
) ]]
