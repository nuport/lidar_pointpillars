...
set(_TensorRT_nvinfer_plugin_SONAME
    "${CMAKE_SHARED_LIBRARY_PREFIX}nvinfer_plugin${CMAKE_SHARED_LIBRARY_SUFFIX}"
)
find_library(TensorRT_nvinfer_plugin_LIBRARY
    NAMES "${_TensorRT_nvinfer_plugin_SONAME}"
    HINTS "${_TensorRT_LIBRARY_DIR}"
)
...
if(TensorRT_FOUND)
    ...
    if(NOT TARGET TensorRT::nvinfer)
        ...
        # cuDLA is a transitive dependency of libnvinfer on DRIVE OS platforms.
        # Wire it in if the cuDLA target was found by the caller.
        if(TARGET cuDLA::cuDLA)
            set_property(TARGET TensorRT::nvinfer APPEND PROPERTY
                INTERFACE_LINK_LIBRARIES cuDLA::cuDLA
            )
        endif()
    endif()
    ...
    if(NOT TARGET TensorRT::nvinfer_plugin)
        ...
        set_target_properties(TensorRT::nvinfer_plugin PROPERTIES
            ...
            IMPORTED_SONAME "${_TensorRT_nvinfer_plugin_SONAME}"
            SOVERSION "${TensorRT_VERSION_MAJOR}"
            VERSION "${TensorRT_VERSION}"
        )
    endif()
